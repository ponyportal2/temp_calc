...
ck_assert_double_eq_tol(strtod("10",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("-326073.35604",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("-40920.7057214",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("15",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("5",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("844.409",NULL), strtod(outputStr,NULL), EPSFOUR);
...
ck_assert_double_eq_tol(strtod("0",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("-6277101735386680763835789423207666416102355444464034512896.0",NULL), strtod(outputStr,NULL), EPS);
...
ck_assert_double_eq_tol(strtod("1.0708",NULL), strtod(outputStr,NULL), EPSFOUR);
...
ck_assert_double_eq_tol(strtod("Invalid symbols encountered",NULL), strtod(outputStr,NULL), EPS);
