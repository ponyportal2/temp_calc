...
ck_assert_str_eq("999999999999999999998992975478877801608360559837361100082259766168576867306596861455892480.0", outputStr);
...
ck_assert_str_eq("-6277101735386680763835789423207666416102355444464034512896.0", outputStr);
